...
export function AdminConsole({ initialTab = 'queue' }: AdminConsoleProps) {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      {/* Header Banner */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-4 border-b border-purple-200/60 dark:border-purple-900/40">
        <div>
          <div className="flex items-center gap-2">
            <span className="w-9 h-9 rounded-xl bg-gradient-to-tr from-purple-600 to-indigo-600 flex items-center justify-center text-white shadow-md shadow-purple-500/20">
          ...
          <p className="text-sm font-semibold text-purple-600 dark:text-purple-400 mt-1.5 flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-purple-500 animate-pulse" />
            Supervise peer-moderated content, reputation thresholds, integrity reports, and Kafka streams.
          </p>
        </div>
