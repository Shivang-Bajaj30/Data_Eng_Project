        ...
        <div className="py-10 text-center space-y-3">
          ...
          <p className="text-xs font-semibold text-emerald-700 dark:text-emerald-300 max-w-md mx-auto leading-relaxed bg-emerald-50 dark:bg-emerald-950/40 p-3 rounded-lg border border-emerald-200 dark:border-emerald-800">
            {uploadFeedback.autoPublished
              ? 'As a Trusted Contributor, your notes have gone live in the public catalog immediately. Event broadcasted to Kafka streams.'
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pb-3 border-b border-indigo-100 dark:border-zinc-800">
            ...
            <p className="text-xs font-semibold text-indigo-600 dark:text-indigo-400 mt-1">
              Attach course files and assign taxonomy metadata for automated AI summarization and semantic indexing.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              <Input
                ...
                helperText="Adding specific keywords enhances student discoverability via semantic search."
              />
            </div>
          </div>
